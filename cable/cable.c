...
int main(int argc, char *argv[])
{
    ...
    system("socat -dd PTY,link=/dev/ttyS10,mode=777 PTY,link=/Users/emulatorTx,mode=777 &");
    sleep(1);
    printf("\n");

    system("socat -dd PTY,link=/dev/ttyS11,mode=777 PTY,link=/Users/emulatorRx,mode=777 &");
    sleep(1);
